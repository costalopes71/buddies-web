					...
					<tbody>
						<c:forEach items="${usuarios}" var="usuario">
							<tr class="text-center">
								...
								<td class="btnsAcoes">
									<c:url var="link" value="/usuario/editar-usuario/${usuario.id}"/>
									<a href="${link}" class="fa fa-pencil-square-o fa-lg btnsAcoes"></a>
								</td>
								<td class="btnsAcoes text-center">
									<a class="fa fa-trash fa-lg" href="#" onclick="idExcluir.value = ${usuario.id}" data-toggle="modal" data-target="#exampleModal"></a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
