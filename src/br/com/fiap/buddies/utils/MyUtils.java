...
public final class MyUtils {
	...
	public static ModelAndView redirectToErrorPage(Exception exception) {
		...
		model.addObject("paginaAtiva", "P�gina de Erro");
		return model;
	}
	...
	/**
	 * @throws Exception 
	 * Pega todos os arquivos de todas as subpastas de um determinador diret�rio e
	 * coloca esses arquivos em um �nico vetor
